...
export const metadata: Metadata = {
  ...
  title: {
    // Градът е в заглавието, защото хората търсят „продукт + град“:
    // „протеинова торта Търговище“, „сладкарница Търговище“. Без него
    // страницата се състезава с цяла България за дума, която не печели.
    default: "Нутрико — протеинова сладкарница без захар в Търговище",
    template: "%s · Нутрико",
  },
  description:
