...
export default function RecipeEditor({
  ...
  // Питаме за ВСЕКИ публикуван продукт. Списък с изключения (категории или
  // `showMacros`) остарява, докато менюто расте — и пропуска точно десерта,
  // на който са скрити макросите. Цената е едно потвърждение за водата и
  // кафето, които и без това се пипат рядко.
  const alergeniLipsvat = isPublished && allergenIds.length === 0;
